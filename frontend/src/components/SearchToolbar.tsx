import { IoCloudDownloadOutline, IoRefreshOutline, IoSearchOutline } from "react-icons/io5";
...
export function SearchToolbar({
  ...
  const showSearchInput = activeView !== "recommendations";
  ...
  return (
    <header className="top controls command-bar">
      ...
      <button className="action-btn primary-action" onClick={onSearch} disabled={loading}>
        {activeView === "recommendations" ? <IoRefreshOutline aria-hidden /> : <IoSearchOutline aria-hidden />}
